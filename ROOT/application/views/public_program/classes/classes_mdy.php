...
<head>
    ...
    <script>
        ...
        window.location="/classes/index?table_name=Front_HotnewsClass"
        <?php } ?>
    </script>
</head>
...
<div style="width:60%;margin: 50px auto;" >
    <div class='panel panel-primary dialog-panel' style="-webkit-box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
        ...
        <div class='panel-body'>
            ...
            echo form_open('classes/mdy_save', $attributes);
            ?>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-6'>
                    <input class='form-control' id='class_name' name="class_name" placeholder='分類名稱' type='text' value="<?php echo xss_clean($item->Subject)?>">
                </div>
            </div>
            <div class='form-group' id="folder_bottom_button">
                <div class='control-label col-xs-6 col-md-6 col-md-offset-2'>
                    <input type="button" class='btn-lg btn-primary' style='float:right' id="mdysave" value="儲存">
                </div>
                <div class='control-label col-xs-6 col-md-6 col-md-offset-2'>
